jsPlumb.ready(function () {
	var instance = jsPlumb.getInstance({
		Connector: 'Straight',
		PaintStyle: { strokeWidth: 2, stroke: '#32CD32', dashstyle: '' },
		Endpoint: ['Dot', { radius: 8 }],
		EndpointStyle: { fill: '#32CD32' },
		Container: 'canvas',
		ListStyle: {
	...
	jsPlumb.on(document, 'change', "[type='checkbox']", function (e) {
		instance[e.srcElement.checked ? 'addList' : 'removeList'](
			e.srcElement.value === 'list1' ? list1Ul : list2Ul
		);
	});
