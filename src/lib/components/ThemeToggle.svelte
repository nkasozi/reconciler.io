...
<button 
  ...
  class="relative inline-flex items-center p-2 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-dark-primary"
  onclick={toggleTheme}
>
  {#if $theme === 'dark'}
