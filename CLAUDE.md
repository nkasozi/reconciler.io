...
- I have a strong prefrence for switch and match statements over long vertical if statements whereever possible. if the language supports them, all code should be biased towards those statements
